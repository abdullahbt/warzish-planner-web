...
var require_NoopWrapper = __commonJS({
  "node_modules/react-big-calendar/lib/NoopWrapper.js"(exports) {
    "use strict";
...
var require_EventWrapper = __commonJS({
  "node_modules/react-big-calendar/lib/EventWrapper.js"(exports) {
    "use strict";
    ...
    exports.default = void 0;
    var _NoopWrapper = _interopRequireDefault(require_NoopWrapper());
    var _default = exports.default = _NoopWrapper.default;
  }
});

// node_modules/react-big-calendar/lib/BackgroundWrapper.js
var require_BackgroundWrapper = __commonJS({
  "node_modules/react-big-calendar/lib/BackgroundWrapper.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
...
var MILI, SECONDS, MINUTES, HOURS, DAY, WEEK, MONTH, YEAR, DECADE, CENTURY, multiplierMilli, multiplierMonth, eq, neq, gt, gte, lt, lte, milliseconds, seconds, minutes, hours, day, date, month, year;
var init_date_arithmetic = __esm({
  "node_modules/date-arithmetic/index.js"() {
    MILI = "milliseconds";
    SECONDS = "seconds";
    MINUTES = "minutes";
...
var require_dates = __commonJS({
  "node_modules/react-big-calendar/lib/utils/dates.js"(exports) {
    "use strict";
    ...
    var dates = _interopRequireWildcard((init_date_arithmetic(), __toCommonJS(date_arithmetic_exports)));
    var MILLI = {
      seconds: 1e3,
      minutes: 1e3 * 60,
      hours: 1e3 * 60 * 60,
    ...
    function monthsInYear(year2) {
      ...
      return MONTHS.map(function(i) {
        return dates.month(date2, i);
      });
    }
    function firstVisibleDay(date2, localizer) {
      var firstOfMonth = dates.startOf(date2, "month");
      return dates.startOf(firstOfMonth, "week", localizer.startOfWeek());
    }
    function lastVisibleDay(date2, localizer) {
      var endOfMonth = dates.endOf(date2, "month");
    ...
    function ceil(date2, unit) {
      var floor = dates.startOf(date2, unit);
      return dates.eq(floor, date2) ? floor : dates.add(floor, 1, unit);
    }
    ...
    function isJustDate(date2) {
      return dates.hours(date2) === 0 && dates.minutes(date2) === 0 && dates.seconds(date2) === 0 && dates.milliseconds(date2) === 0;
    }
    function duration(start, end, unit, firstOfWeek) {
      if (unit === "day") unit = "date";
      return Math.abs(
        // eslint-disable-next-line import/namespace
        dates[unit](start, void 0, firstOfWeek) - // eslint-disable-next-line import/namespace
        dates[unit](end, void 0, firstOfWeek)
      );
    }
    ...
    function total(date2, unit) {
      var ms = date2.getTime(), div = 1;
      switch (unit) {
        case "week":
          div *= 7;
        case "day":
...
var require_localizer = __commonJS({
  "node_modules/react-big-calendar/lib/localizer.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
    ...
    var DateLocalizer = exports.DateLocalizer = (0, _createClass2.default)(function DateLocalizer2(spec) {
      var _this = this;
      (0, _classCallCheck2.default)(this, DateLocalizer2);
...
var require_Toolbar = __commonJS({
  "node_modules/react-big-calendar/lib/Toolbar.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
    ...
    var Toolbar = function(_React$Component) {
      function Toolbar2() {
        var _this;
        (0, _classCallCheck2.default)(this, Toolbar2);
        for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
          args[_key] = arguments[_key];
        }
        _this = (0, _callSuper2.default)(this, Toolbar2, [].concat(args));
      ...
      (0, _inherits2.default)(Toolbar2, _React$Component);
      return (0, _createClass2.default)(Toolbar2, [{
        key: "render",
...
var require_helpers = __commonJS({
  "node_modules/react-big-calendar/lib/utils/helpers.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
var require_messages = __commonJS({
  "node_modules/react-big-calendar/lib/utils/messages.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
...
var import_react5, useCommittedRef_default;
...
var import_react9, DropdownContext, DropdownContext_default;
var init_DropdownContext = __esm({
  "node_modules/react-overlays/esm/DropdownContext.js"() {
    import_react9 = __toESM(require_react());
    DropdownContext = import_react9.default.createContext(null);
...
var import_react12, useSafeState_default;
...
var import_react13, initialPopperStyles, disabledApplyStylesModifier, ariaDescribedByModifier, EMPTY_MODIFIERS, usePopper_default;
var init_usePopper = __esm({
  "node_modules/react-overlays/esm/usePopper.js"() {
    ...
    init_useSafeState();
    init_popper();
    initialPopperStyles = function initialPopperStyles2(position2) {
      return {
        position: position2,
        top: "0",
        left: "0",
...
var init_ownerDocument2 = __esm({
  "node_modules/react-overlays/esm/ownerDocument.js"() {
    ...
    ownerDocument_default = function(componentOrElement) {
...
var import_react14, import_warning, escapeKeyCode, noop3, getRefTarget, useRootClose_default;
...
var import_prop_types, import_react15, noop5, propTypes, defaultProps, DropdownMenu_default;
...
var import_prop_types2, import_react16, noop7, propTypes2, DropdownToggle_default;
var init_DropdownToggle = __esm({
  "node_modules/react-overlays/esm/DropdownToggle.js"() {
    import_prop_types2 = __toESM(require_prop_types());
    import_react16 = __toESM(require_react());
    init_DropdownContext();
    noop7 = function noop8() {
    };
    propTypes2 = {
      /**
...
var import_react17, import_prop_types3, propTypes3, Dropdown_default;
...
var BLACKLIST, isHidable, siblings;
var init_manageAriaHidden = __esm({
  "node_modules/react-overlays/esm/manageAriaHidden.js"() {
    BLACKLIST = ["template", "script", "style"];
    isHidable = function isHidable2(_ref) {
      var nodeType = _ref.nodeType, tagName = _ref.tagName;
      return nodeType === 1 && BLACKLIST.indexOf(tagName.toLowerCase()) === -1;
    };
    siblings = function siblings2(container, exclude, cb) {
...
var import_react20, resolveContainerRef;
var init_useWaitForDOMRef = __esm({
  "node_modules/react-overlays/esm/useWaitForDOMRef.js"() {
    init_ownerDocument();
    import_react20 = __toESM(require_react());
    resolveContainerRef = function resolveContainerRef2(ref) {
      var _ref;
...
var import_prop_types4, import_react21, import_react_dom2, manager, Modal, propTypes4, Modal_default;
var init_Modal = __esm({
  "node_modules/react-overlays/esm/Modal.js"() {
    ...
    Modal = (0, import_react21.forwardRef)(function(_ref, ref) {
...
var import_react22, toFnRef, useMergedRefs_default;
...
var import_prop_types5, import_react23, import_react_dom3, Overlay, Overlay_default;
var init_Overlay = __esm({
  "node_modules/react-overlays/esm/Overlay.js"() {
    ...
    init_useWaitForDOMRef();
    init_mergeOptionsWithPopperConfig();
    Overlay = import_react23.default.forwardRef(function(props, outerRef) {
...
var import_prop_types6, import_react_dom4, import_react24, propTypes5, Portal, Portal_default;
...
__export(esm_exports2, {
  ...
  useRootClose: () => useRootClose_default
});
var init_esm2 = __esm({
  "node_modules/react-overlays/esm/index.js"() {
    init_Dropdown();
...
// node_modules/react-big-calendar/lib/hooks/useClickOutside.js
var require_useClickOutside = __commonJS({
  "node_modules/react-big-calendar/lib/hooks/useClickOutside.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
      ...
      return (0, _createClass2.default)(EventCell2, [{
        ...
        value: function render() {
          ...
          return _react.default.createElement(EventWrapper, Object.assign({}, this.props, {
            ...
            style: (0, _objectSpread2.default)((0, _objectSpread2.default)({}, userProps.style), style2),
...
var require_Popup = __commonJS({
  "node_modules/react-big-calendar/lib/Popup.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    var _interopRequireWildcard = require_interopRequireWildcard().default;
    Object.defineProperty(exports, "__esModule", {
    ...
    var _propTypes = _interopRequireDefault(require_prop_types());
    var _offset = _interopRequireDefault((init_offset2(), __toCommonJS(offset_exports)));
    var _useClickOutside = _interopRequireDefault(require_useClickOutside());
    ...
    function getPosition(_ref) {
      ...
      var _getOffset = (0, _offset.default)(target), top = _getOffset.top, left = _getOffset.left, width = _getOffset.width, height2 = _getOffset.height;
      var _getOffset2 = (0, _offset.default)(container), cTop = _getOffset2.top, cLeft = _getOffset2.left, cWidth = _getOffset2.width, cHeight = _getOffset2.height;
      var _getOffset3 = (0, _offset.default)(box), bWidth = _getOffset3.width, bHeight = _getOffset3.height;
    ...
    function Pop(_ref2) {
      var containerRef = _ref2.containerRef, accessors = _ref2.accessors, getters = _ref2.getters, selected = _ref2.selected, components = _ref2.components, localizer = _ref2.localizer, position2 = _ref2.position, show = _ref2.show, events = _ref2.events, slotStart = _ref2.slotStart, slotEnd = _ref2.slotEnd, onSelect = _ref2.onSelect, onDoubleClick = _ref2.onDoubleClick, onKeyPress = _ref2.onKeyPress, handleDragStart = _ref2.handleDragStart, popperRef = _ref2.popperRef, target = _ref2.target, offset2 = _ref2.offset;
    ...
    var Popup = _react.default.forwardRef(function(props, ref) {
      return _react.default.createElement(Pop, Object.assign({}, props, {
        popperRef: ref
      }));
    });
    Popup.propTypes = {
...
// node_modules/react-big-calendar/lib/PopOverlay.js
var require_PopOverlay = __commonJS({
  "node_modules/react-big-calendar/lib/PopOverlay.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    var _interopRequireWildcard = require_interopRequireWildcard().default;
    Object.defineProperty(exports, "__esModule", {
    ...
    var _react = _interopRequireWildcard(require_react());
    var _propTypes = _interopRequireDefault(require_prop_types());
    var _reactOverlays = (init_esm2(), __toCommonJS(esm_exports2));
    ...
    function CalOverlay(_ref) {
      ...
      return _react.default.createElement(_reactOverlays.Overlay, {
        rootClose: true,
        flip: true,
        show: true,
        placement: "bottom",
        ...
        return _react.default.createElement(_Popup.default, Object.assign({}, props, {
          containerRef,
          ref: popperRef,
          target: overlay.target,
          offset: offset2,
    ...
    var PopOverlay = _react.default.forwardRef(function(props, ref) {
      return _react.default.createElement(CalOverlay, Object.assign({}, props, {
        containerRef: ref
      }));
    });
...
var require_BackgroundCells = __commonJS({
  "node_modules/react-big-calendar/lib/BackgroundCells.js"(exports) {
    "use strict";
    var _interopRequireWildcard = require_interopRequireWildcard().default;
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
    ...
    var BackgroundCells = function(_React$Component) {
      function BackgroundCells2(props, context) {
        var _this;
        (0, _classCallCheck2.default)(this, BackgroundCells2);
        _this = (0, _callSuper2.default)(this, BackgroundCells2, [props, context]);
        _this.state = {
          selecting: false
        };
      ...
      (0, _inherits2.default)(BackgroundCells2, _React$Component);
      return (0, _createClass2.default)(BackgroundCells2, [{
        ...
        value: function render() {
          ...
          return _react.default.createElement("div", {
          ...
          }, range.map(function(date2, index) {
            ...
            return _react.default.createElement(Wrapper, {
              ...
              style: style2,
              className: (0, _clsx.default)("rbc-day-bg", className, selected && "rbc-selected-cell", localizer.isSameDate(date2, current) && "rbc-today", currentDate && localizer.neq(currentDate, date2, "month") && "rbc-off-range-bg")
            }));
          }));
        }
      }, {
...
var require_EventEndingRow = __commonJS({
  "node_modules/react-big-calendar/lib/EventEndingRow.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
    ...
    var EventEndingRow = function(_React$Component) {
      function EventEndingRow2() {
        (0, _classCallCheck2.default)(this, EventEndingRow2);
        return (0, _callSuper2.default)(this, EventEndingRow2, arguments);
      }
      (0, _inherits2.default)(EventEndingRow2, _React$Component);
      return (0, _createClass2.default)(EventEndingRow2, [{
        key: "render",
        value: function render() {
        ...
        value: function renderShowMore(segments, slot) {
          ...
          if (components !== null && components !== void 0 && components.showMore) {
            ...
            return count ? _react.default.createElement(ShowMore, {
              localizer,
              slotDate,
              slot,
              count,
          ...
          return count ? _react.default.createElement("button", {
            type: "button",
            key: "sm_" + slot,
...
// node_modules/react-big-calendar/lib/ScrollableWeekWrapper.js
var require_ScrollableWeekWrapper = __commonJS({
  "node_modules/react-big-calendar/lib/ScrollableWeekWrapper.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
...
var require_DateSlotMetrics = __commonJS({
  "node_modules/react-big-calendar/lib/utils/DateSlotMetrics.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
    ...
    var _eventLevels2 = require_eventLevels();
    var isSegmentInSlot = function isSegmentInSlot2(seg, slot) {
      return seg.left <= slot && seg.right >= slot;
    };
    ...
    function getSlotMetrics() {
      return (0, _memoizeOne.default)(function(options) {
        ...
        var _eventLevels = (0, _eventLevels2.eventLevels)(segments, Math.max(maxRows - 1, 1)), levels = _eventLevels.levels, extra = _eventLevels.extra;
...
var require_DateContentRow = __commonJS({
  "node_modules/react-big-calendar/lib/DateContentRow.js"(exports) {
    "use strict";
    var _interopRequireWildcard = require_interopRequireWildcard().default;
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
    ...
    var _react = _interopRequireWildcard(require_react());
    var _clsx = _interopRequireDefault((init_clsx_m(), __toCommonJS(clsx_m_exports)));
    var _height = _interopRequireDefault((init_height(), __toCommonJS(height_exports)));
    var _querySelectorAll = _interopRequireDefault((init_querySelectorAll(), __toCommonJS(querySelectorAll_exports)));
    var _BackgroundCells = _interopRequireDefault(require_BackgroundCells());
    var _EventRow = _interopRequireDefault(require_EventRow());
    var _EventEndingRow = _interopRequireDefault(require_EventEndingRow());
    var _NoopWrapper = _interopRequireDefault(require_NoopWrapper());
    var _ScrollableWeekWrapper = _interopRequireDefault(require_ScrollableWeekWrapper());
    var DateSlotMetrics = _interopRequireWildcard(require_DateSlotMetrics());
    var DateContentRow = function(_React$Component) {
      function DateContentRow2() {
        var _this;
        (0, _classCallCheck2.default)(this, DateContentRow2);
        for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
          args[_key] = arguments[_key];
        }
        _this = (0, _callSuper2.default)(this, DateContentRow2, [].concat(args));
        ...
        _this.renderHeadingCell = function(date2, index) {
          ...
          return renderHeader({
            ...
            className: (0, _clsx.default)("rbc-date-cell", localizer.isSameDate(date2, getNow()) && "rbc-now")
          });
        };
        ...
        _this.containerRef = (0, _react.createRef)();
        _this.headingRowRef = (0, _react.createRef)();
        _this.eventRowRef = (0, _react.createRef)();
        _this.slotMetrics = DateSlotMetrics.getSlotMetrics();
        return _this;
      }
      (0, _inherits2.default)(DateContentRow2, _React$Component);
      return (0, _createClass2.default)(DateContentRow2, [{
        key: "getRowLimit",
        ...
        value: function render() {
          ...
          }, range.map(this.renderHeadingCell)), _react.default.createElement(ScrollableWeekComponent, null, _react.default.createElement(WeekWrapper, Object.assign({
            isAllDay
          }, eventRowProps, {
            rtl: this.props.rtl
          }), levels.map(function(segs, idx) {
            return _react.default.createElement(_EventRow.default, Object.assign({
              key: idx,
              segments: segs
            }, eventRowProps));
          }), !!extra.length && _react.default.createElement(_EventEndingRow.default, Object.assign({
            segments: extra,
...
var require_Header = __commonJS({
  "node_modules/react-big-calendar/lib/Header.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
...
var require_DateHeader = __commonJS({
  "node_modules/react-big-calendar/lib/DateHeader.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
...
var require_Month = __commonJS({
  "node_modules/react-big-calendar/lib/Month.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    var _interopRequireWildcard = require_interopRequireWildcard().default;
    Object.defineProperty(exports, "__esModule", {
    ...
    var _react = _interopRequireWildcard(require_react());
    var _clsx = _interopRequireDefault((init_clsx_m(), __toCommonJS(clsx_m_exports)));
    var _chunk = _interopRequireDefault(require_chunk());
    var _constants = require_constants();
    var _helpers = require_helpers();
    var _position = _interopRequireDefault((init_position(), __toCommonJS(position_exports)));
    var animationFrame = _interopRequireWildcard((init_animationFrame(), __toCommonJS(animationFrame_exports)));
    var _PopOverlay = _interopRequireDefault(require_PopOverlay());
    var _DateContentRow = _interopRequireDefault(require_DateContentRow());
    ...
    var MonthView = function(_React$Component) {
      function MonthView2() {
        var _this;
        (0, _classCallCheck2.default)(this, MonthView2);
        for (var _len = arguments.length, _args = new Array(_len), _key = 0; _key < _len; _key++) {
          _args[_key] = arguments[_key];
        }
        _this = (0, _callSuper2.default)(this, MonthView2, [].concat(_args));
        _this.getContainer = function() {
          return _this.containerRef.current;
        };
        _this.renderWeek = function(week, weekIdx) {
          var _this$props = _this.props, events = _this$props.events, components = _this$props.components, selectable = _this$props.selectable, getNow = _this$props.getNow, selected = _this$props.selected, date2 = _this$props.date, localizer = _this$props.localizer, longPressThreshold = _this$props.longPressThreshold, accessors = _this$props.accessors, getters = _this$props.getters, showAllEvents = _this$props.showAllEvents;
        ...
        _this.readerDateHeading = function(_ref) {
          var date2 = _ref.date, className = _ref.className, props = (0, _objectWithoutProperties2.default)(_ref, _excluded);
        ...
        _this.handleHeadingClick = function(date2, view, e) {
          ...
          (0, _helpers.notify)(_this.props.onDrillDown, [date2, view]);
        };
        ...
        _this.handleShowMore = function(events, date2, cell, slot, target) {
          ...
          _this.clearSelection();
          if (popup) {
            var position2 = (0, _position.default)(cell, _this.containerRef.current);
            _this.setState({
              overlay: {
                date: date2,
                events,
            ...
            (0, _helpers.notify)(onDrillDown, [date2, getDrilldownView(date2) || _constants.views.DAY]);
          }
          (0, _helpers.notify)(onShowMore, [events, date2, slot]);
        };
        ...
        _this.containerRef = (0, _react.createRef)();
        _this.slotRowRef = (0, _react.createRef)();
        _this._bgRows = [];
        _this._pendingSelection = [];
        return _this;
      }
      (0, _inherits2.default)(MonthView2, _React$Component);
      return (0, _createClass2.default)(MonthView2, [{
        key: "componentDidMount",
        value: function componentDidMount() {
          var _this2 = this;
          var running;
        ...
        key: "render",
        value: function render() {
          var _this$props4 = this.props, date2 = _this$props4.date, localizer = _this$props4.localizer, className = _this$props4.className, month2 = localizer.visibleDays(date2, localizer), weeks = (0, _chunk.default)(month2, 7);
        ...
        value: function renderOverlay() {
          ...
          return _react.default.createElement(_PopOverlay.default, {
            overlay,
            accessors,
            localizer,
            components,
...
var require_TimeSlots = __commonJS({
  "node_modules/react-big-calendar/lib/utils/TimeSlots.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
// node_modules/react-big-calendar/lib/utils/layout-algorithms/overlap.js
var require_overlap = __commonJS({
  "node_modules/react-big-calendar/lib/utils/layout-algorithms/overlap.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
    ...
    var Event = function() {
      function Event2(data, _ref) {
        ...
        (0, _classCallCheck2.default)(this, Event2);
      ...
      return (0, _createClass2.default)(Event2, [{
        key: "_width",
        get: function get() {
          if (this.rows) {
...
var require_no_overlap = __commonJS({
  "node_modules/react-big-calendar/lib/utils/layout-algorithms/no-overlap.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
    ...
    var _overlap = _interopRequireDefault(require_overlap());
...
var require_DayEventLayout = __commonJS({
  "node_modules/react-big-calendar/lib/utils/DayEventLayout.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
    ...
    var _overlap = _interopRequireDefault(require_overlap());
    var _noOverlap = _interopRequireDefault(require_no_overlap());
    ...
    function getStyledEvents(_ref) {
      var events = _ref.events, minimumStartDifference = _ref.minimumStartDifference, slotMetrics = _ref.slotMetrics, accessors = _ref.accessors, dayLayoutAlgorithm = _ref.dayLayoutAlgorithm;
...
var require_TimeSlotGroup = __commonJS({
  "node_modules/react-big-calendar/lib/TimeSlotGroup.js"(exports) {
    "use strict";
    var _interopRequireWildcard = require_interopRequireWildcard().default;
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
    ...
    var _clsx = _interopRequireDefault((init_clsx_m(), __toCommonJS(clsx_m_exports)));
    var _react = _interopRequireWildcard(require_react());
    var _BackgroundWrapper = _interopRequireDefault(require_BackgroundWrapper());
    var TimeSlotGroup = exports.default = function(_Component) {
      function TimeSlotGroup2() {
        (0, _classCallCheck2.default)(this, TimeSlotGroup2);
        return (0, _callSuper2.default)(this, TimeSlotGroup2, arguments);
      }
      (0, _inherits2.default)(TimeSlotGroup2, _Component);
      return (0, _createClass2.default)(TimeSlotGroup2, [{
        key: "render",
        value: function render() {
          var _this$props = this.props, renderSlot = _this$props.renderSlot, resource = _this$props.resource, group = _this$props.group, getters = _this$props.getters, _this$props$component = _this$props.components, _this$props$component2 = _this$props$component === void 0 ? {} : _this$props$component, _this$props$component3 = _this$props$component2.timeSlotWrapper, Wrapper = _this$props$component3 === void 0 ? _BackgroundWrapper.default : _this$props$component3;
          ...
          return _react.default.createElement("div", Object.assign({
            ...
            return _react.default.createElement(Wrapper, {
              ...
              value,
              resource
            }, _react.default.createElement("div", Object.assign({}, slotProps, {
...
var require_TimeGridEvent = __commonJS({
  "node_modules/react-big-calendar/lib/TimeGridEvent.js"(exports) {
    ...
    function TimeGridEvent(props) {
      var style2 = props.style, className = props.className, event = props.event, accessors = props.accessors, rtl = props.rtl, selected = props.selected, label = props.label, continuesPrior = props.continuesPrior, continuesAfter = props.continuesAfter, getters = props.getters, onClick = props.onClick, onDoubleClick = props.onDoubleClick, isBackgroundEvent = props.isBackgroundEvent, onKeyPress = props.onKeyPress, _props$components = props.components, Event = _props$components.event, EventWrapper = _props$components.eventWrapper;
      var title = accessors.title(event);
      var tooltip = accessors.tooltip(event);
      var end = accessors.end(event);
      var start = accessors.start(event);
...
// node_modules/react-big-calendar/lib/DayColumnWrapper.js
var require_DayColumnWrapper = __commonJS({
  "node_modules/react-big-calendar/lib/DayColumnWrapper.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
    ...
    var _default = exports.default = _react.default.forwardRef(function(props, ref) {
      return _react.default.createElement(DayColumnWrapper, Object.assign({}, props, {
        innerRef: ref
      }));
    });
  }
...
var require_DayColumn = __commonJS({
  "node_modules/react-big-calendar/lib/DayColumn.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    var _interopRequireWildcard = require_interopRequireWildcard().default;
    Object.defineProperty(exports, "__esModule", {
    ...
    var _clsx = _interopRequireDefault((init_clsx_m(), __toCommonJS(clsx_m_exports)));
    var _Selection = _interopRequireWildcard(require_Selection());
    var TimeSlotUtils = _interopRequireWildcard(require_TimeSlots());
    var _selection = require_selection();
    var _helpers = require_helpers();
    var DayEventLayout = _interopRequireWildcard(require_DayEventLayout());
    var _TimeSlotGroup = _interopRequireDefault(require_TimeSlotGroup());
    var _TimeGridEvent = _interopRequireDefault(require_TimeGridEvent());
    var _propTypes = require_propTypes();
    var _DayColumnWrapper = _interopRequireDefault(require_DayColumnWrapper());
    var _excluded = ["dayProp"];
    var _excluded2 = ["eventContainerWrapper"];
    var DayColumn = function(_React$Component) {
      function DayColumn2() {
        var _this;
        (0, _classCallCheck2.default)(this, DayColumn2);
        for (var _len = arguments.length, _args = new Array(_len), _key = 0; _key < _len; _key++) {
          _args[_key] = arguments[_key];
        }
        _this = (0, _callSuper2.default)(this, DayColumn2, [].concat(_args));
        _this.state = {
          selecting: false,
      ...
      (0, _inherits2.default)(DayColumn2, _React$Component);
      return (0, _createClass2.default)(DayColumn2, [{
        key: "componentDidMount",
        value: function componentDidMount() {
          this.props.selectable && this._selectable();
          if (this.props.isNow) {
        ...
        value: function componentDidUpdate(prevProps, prevState) {
          ...
          var _this$props3 = this.props, getNow = _this$props3.getNow, isNow = _this$props3.isNow, localizer = _this$props3.localizer, date2 = _this$props3.date, min2 = _this$props3.min, max2 = _this$props3.max;
        ...
        value: function positionTimeIndicator() {
          var _this$props4 = this.props, min2 = _this$props4.min, max2 = _this$props4.max, getNow = _this$props4.getNow;
          var current = getNow();
        ...
        key: "render",
        value: function render() {
          var _this$props5 = this.props, date2 = _this$props5.date, max2 = _this$props5.max, rtl = _this$props5.rtl, isNow = _this$props5.isNow, resource = _this$props5.resource, accessors = _this$props5.accessors, localizer = _this$props5.localizer, _this$props5$getters = _this$props5.getters, dayProp = _this$props5$getters.dayProp, getters = (0, _objectWithoutProperties2.default)(_this$props5$getters, _excluded), _this$props5$componen = _this$props5.components, EventContainer = _this$props5$componen.eventContainerWrapper, components = (0, _objectWithoutProperties2.default)(_this$props5$componen, _excluded2);
...
// node_modules/react-big-calendar/lib/ResourceHeader.js
var require_ResourceHeader = __commonJS({
  "node_modules/react-big-calendar/lib/ResourceHeader.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
...
var require_TimeGridHeader = __commonJS({
  "node_modules/react-big-calendar/lib/TimeGridHeader.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
    ...
    var _DateContentRow = _interopRequireDefault(require_DateContentRow());
    var _Header = _interopRequireDefault(require_Header());
    var _ResourceHeader = _interopRequireDefault(require_ResourceHeader());
    var _helpers = require_helpers();
    var TimeGridHeader = function(_React$Component) {
      function TimeGridHeader2() {
        var _this;
        (0, _classCallCheck2.default)(this, TimeGridHeader2);
        for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
          args[_key] = arguments[_key];
        }
        _this = (0, _callSuper2.default)(this, TimeGridHeader2, [].concat(args));
      ...
      (0, _inherits2.default)(TimeGridHeader2, _React$Component);
      return (0, _createClass2.default)(TimeGridHeader2, [{
        key: "renderHeaderCells",
        value: function renderHeaderCells(range) {
          var _this2 = this;
          var _this$props2 = this.props, localizer = _this$props2.localizer, getDrilldownView = _this$props2.getDrilldownView, getNow = _this$props2.getNow, dayProp = _this$props2.getters.dayProp, _this$props2$componen = _this$props2.components.header, HeaderComponent = _this$props2$componen === void 0 ? _Header.default : _this$props2$componen;
          var today = getNow();
          return range.map(function(date2, i) {
            var drilldownView = getDrilldownView(date2);
            ...
            return _react.default.createElement("div", {
              key: i,
              style: style2,
              className: (0, _clsx.default)("rbc-header", className, localizer.isSameDate(date2, today) && "rbc-today")
            }, drilldownView ? _react.default.createElement("button", {
              type: "button",
              className: "rbc-button-link",
              onClick: function onClick(e) {
        ...
        value: function render() {
          ...
          return _react.default.createElement("div", {
            ...
            var _ref2 = (0, _slicedToArray2.default)(_ref, 2), id = _ref2[0], resource = _ref2[1];
            return _react.default.createElement("div", {
...
// node_modules/react-big-calendar/lib/TimeGridHeaderResources.js
var require_TimeGridHeaderResources = __commonJS({
  "node_modules/react-big-calendar/lib/TimeGridHeaderResources.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
    ...
    var TimeGridHeaderResources = function(_React$Component) {
      function TimeGridHeaderResources2() {
        var _this;
        (0, _classCallCheck2.default)(this, TimeGridHeaderResources2);
        for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
          args[_key] = arguments[_key];
        }
        _this = (0, _callSuper2.default)(this, TimeGridHeaderResources2, [].concat(args));
        _this.handleHeaderClick = function(date2, view, e) {
          e.preventDefault();
          (0, _helpers.notify)(_this.props.onDrillDown, [date2, view]);
        };
      ...
      (0, _inherits2.default)(TimeGridHeaderResources2, _React$Component);
      return (0, _createClass2.default)(TimeGridHeaderResources2, [{
        key: "renderHeaderCells",
        value: function renderHeaderCells(range) {
          var _this2 = this;
          var _this$props = this.props, localizer = _this$props.localizer, getDrilldownView = _this$props.getDrilldownView, getNow = _this$props.getNow, dayProp = _this$props.getters.dayProp, _this$props$component = _this$props.components, _this$props$component2 = _this$props$component.header, HeaderComponent = _this$props$component2 === void 0 ? _Header.default : _this$props$component2, _this$props$component3 = _this$props$component.resourceHeader, ResourceHeaderComponent = _this$props$component3 === void 0 ? _ResourceHeader.default : _this$props$component3, resources = _this$props.resources, accessors = _this$props.accessors, events = _this$props.events, rtl = _this$props.rtl, selectable = _this$props.selectable, components = _this$props.components, getters = _this$props.getters, resizable = _this$props.resizable;
          var today = getNow();
          var groupedEvents = resources.groupEvents(events);
          return range.map(function(date2, idx) {
            var drilldownView = getDrilldownView(date2);
            var label = localizer.format(date2, "dayFormat");
            var _dayProp = dayProp(date2), className = _dayProp.className, style2 = _dayProp.style;
            var header = _react.default.createElement(HeaderComponent, {
            ...
            return _react.default.createElement("div", {
            ...
            }, header) : _react.default.createElement("span", null, header))), _react.default.createElement("div", {
              className: "rbc-row"
              ...
              var _ref4 = (0, _slicedToArray2.default)(_ref3, 2), id = _ref4[0], resource = _ref4[1];
        ...
        key: "render",
        value: function render() {
          var _this$props2 = this.props, width = _this$props2.width, rtl = _this$props2.rtl, range = _this$props2.range, scrollRef = _this$props2.scrollRef, isOverflowing2 = _this$props2.isOverflowing, TimeGutterHeader = _this$props2.components.timeGutterHeader;
          var style2 = {};
          if (isOverflowing2) {
            style2[rtl ? "marginLeft" : "marginRight"] = "".concat((0, _scrollbarSize.default)() - 1, "px");
          }
          ...
          }, TimeGutterHeader && _react.default.createElement(TimeGutterHeader, null)), this.renderHeaderCells(range));
        }
      }]);
    }(_react.default.Component);
...
var require_TimeGutter = __commonJS({
  "node_modules/react-big-calendar/lib/TimeGutter.js"(exports) {
    "use strict";
    var _interopRequireWildcard = require_interopRequireWildcard().default;
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
    ...
    var _react = _interopRequireWildcard(require_react());
    var _clsx = _interopRequireDefault((init_clsx_m(), __toCommonJS(clsx_m_exports)));
    var _TimeSlots = require_TimeSlots();
    var _TimeSlotGroup = _interopRequireDefault(require_TimeSlotGroup());
    ...
    var TimeGutter = function TimeGutter2(_ref2) {
      var min2 = _ref2.min, max2 = _ref2.max, timeslots = _ref2.timeslots, step = _ref2.step, localizer = _ref2.localizer, getNow = _ref2.getNow, resource = _ref2.resource, components = _ref2.components, getters = _ref2.getters, gutterRef = _ref2.gutterRef;
      ...
      var _useState = (0, _react.useState)((0, _TimeSlots.getSlotMetrics)({
        ...
        step,
        localizer
      })), _useState2 = (0, _slicedToArray2.default)(_useState, 2), slotMetrics = _useState2[0], setSlotMetrics = _useState2[1];
      (0, _react.useEffect)(function() {
        if (slotMetrics) {
      ...
      return _react.default.createElement(TimeGutterWrapper, {
        slotMetrics
      }, _react.default.createElement("div", {
    ...
    var _default = exports.default = _react.default.forwardRef(function(props, ref) {
      return _react.default.createElement(TimeGutter, Object.assign({
        gutterRef: ref
      }, props));
    });
  }
...
var require_Resources = __commonJS({
  "node_modules/react-big-calendar/lib/utils/Resources.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
...
var require_TimeGrid = __commonJS({
  "node_modules/react-big-calendar/lib/TimeGrid.js"(exports) {
    "use strict";
    var _interopRequireWildcard = require_interopRequireWildcard().default;
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
    ...
    var _react = _interopRequireWildcard(require_react());
    var _position = _interopRequireDefault((init_position(), __toCommonJS(position_exports)));
    var _width = _interopRequireDefault((init_width(), __toCommonJS(width_exports)));
    var _DayColumn = _interopRequireDefault(require_DayColumn());
    var _PopOverlay = _interopRequireDefault(require_PopOverlay());
    var _TimeGridHeader = _interopRequireDefault(require_TimeGridHeader());
    var _TimeGridHeaderResources = _interopRequireDefault(require_TimeGridHeaderResources());
    var _TimeGutter = _interopRequireDefault(require_TimeGutter());
    var _constants = require_constants();
    var _eventLevels = require_eventLevels();
    var _helpers = require_helpers();
    var _propTypes = require_propTypes();
    var _Resources = _interopRequireDefault(require_Resources());
    var TimeGrid = exports.default = function(_Component) {
      function TimeGrid2(props) {
        var _this;
        (0, _classCallCheck2.default)(this, TimeGrid2);
        _this = (0, _callSuper2.default)(this, TimeGrid2, [props]);
          ...
          if (popup) {
            ...
            _this.setState({
              overlay: {
                date: date2,
                events,
                position: (0, _objectSpread2.default)((0, _objectSpread2.default)({}, position2), {}, {
                  width: "200px"
                }),
                target
              }
        ...
        _this.gutterRef = (0, _react.createRef)();
        return _this;
      }
      (0, _inherits2.default)(TimeGrid2, _Component);
      return (0, _createClass2.default)(TimeGrid2, [{
        ...
        key: "renderDayColumn",
        value: function renderDayColumn(date2, id, resource, groupedEvents, groupedBackgroundEvents, localizer, accessors, components, dayLayoutAlgorithm, now) {
          ...
          return _react.default.createElement(_DayColumn.default, Object.assign({}, this.props, {
            localizer,
        ...
        value: function renderResourcesFirst(range, resources, groupedEvents, groupedBackgroundEvents, localizer, accessors, now, components, dayLayoutAlgorithm) {
          ...
          return resources.map(function(_ref) {
            var _ref2 = (0, _slicedToArray2.default)(_ref, 2), id = _ref2[0], resource = _ref2[1];
            return range.map(function(date2) {
              return _this2.renderDayColumn(date2, id, resource, groupedEvents, groupedBackgroundEvents, localizer, accessors, components, dayLayoutAlgorithm, now);
            });
          });
        }
      }, {
        ...
        value: function renderRangeFirst(range, resources, groupedEvents, groupedBackgroundEvents, localizer, accessors, now, components, dayLayoutAlgorithm) {
          ...
          return range.map(function(date2) {
            return _react.default.createElement("div", {
              ...
              }, _this3.renderDayColumn(date2, id, resource, groupedEvents, groupedBackgroundEvents, localizer, accessors, components, dayLayoutAlgorithm, now));
            }));
          });
        }
      }, {
        ...
        value: function render() {
          ...
          return _react.default.createElement("div", {
            ...
            ref: this.containerRef
          }, resources && resources.length > 1 && resourceGroupingLayout ? _react.default.createElement(_TimeGridHeaderResources.default, headerProps) : _react.default.createElement(_TimeGridHeader.default, headerProps), this.props.popup && this.renderOverlay(), _react.default.createElement("div", {
            ref: this.contentRef,
        ...
        value: function measureGutter() {
          ...
          this.measureGutterAnimationFrameRequest = window.requestAnimationFrame(function() {
            ...
            var width = (_this5$gutterRef = _this5.gutterRef) !== null && _this5$gutterRef !== void 0 && _this5$gutterRef.current ? (0, _width.default)(_this5.gutterRef.current) : void 0;
...
var require_Day = __commonJS({
  "node_modules/react-big-calendar/lib/Day.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
    ...
    var _constants = require_constants();
    var _propTypes = require_propTypes();
    var _TimeGrid = _interopRequireDefault(require_TimeGrid());
    var _excluded = ["date", "localizer", "min", "max", "scrollToTime", "enableAutoScroll"];
    var Day = function(_React$Component) {
      function Day2() {
        (0, _classCallCheck2.default)(this, Day2);
        return (0, _callSuper2.default)(this, Day2, arguments);
      }
      (0, _inherits2.default)(Day2, _React$Component);
      return (0, _createClass2.default)(Day2, [{
        key: "render",
        value: function render() {
          var _this$props = this.props, date2 = _this$props.date, localizer = _this$props.localizer, _this$props$min = _this$props.min, min2 = _this$props$min === void 0 ? localizer.startOf(/* @__PURE__ */ new Date(), "day") : _this$props$min, _this$props$max = _this$props.max, max2 = _this$props$max === void 0 ? localizer.endOf(/* @__PURE__ */ new Date(), "day") : _this$props$max, _this$props$scrollToT = _this$props.scrollToTime, scrollToTime = _this$props$scrollToT === void 0 ? localizer.startOf(/* @__PURE__ */ new Date(), "day") : _this$props$scrollToT, _this$props$enableAut = _this$props.enableAutoScroll, enableAutoScroll = _this$props$enableAut === void 0 ? true : _this$props$enableAut, props = (0, _objectWithoutProperties2.default)(_this$props, _excluded);
          var range = Day2.range(date2, {
            localizer
          });
          return _react.default.createElement(_TimeGrid.default, Object.assign({}, props, {
            range,
            eventOffset: 10,
            localizer,
            min: min2,
...
var require_toArray = __commonJS({
  "node_modules/@babel/runtime/helpers/toArray.js"(exports, module) {
    ...
    function _toArray(r2) {
      return arrayWithHoles(r2) || iterableToArray(r2) || unsupportedIterableToArray(r2) || nonIterableRest();
    }
...
var require_Week = __commonJS({
  "node_modules/react-big-calendar/lib/Week.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
    ...
    var Week = function(_React$Component) {
      function Week2() {
        (0, _classCallCheck2.default)(this, Week2);
        return (0, _callSuper2.default)(this, Week2, arguments);
      }
      (0, _inherits2.default)(Week2, _React$Component);
      return (0, _createClass2.default)(Week2, [{
        key: "render",
        value: function render() {
          var _this$props = this.props, date2 = _this$props.date, localizer = _this$props.localizer, _this$props$min = _this$props.min, min2 = _this$props$min === void 0 ? localizer.startOf(/* @__PURE__ */ new Date(), "day") : _this$props$min, _this$props$max = _this$props.max, max2 = _this$props$max === void 0 ? localizer.endOf(/* @__PURE__ */ new Date(), "day") : _this$props$max, _this$props$scrollToT = _this$props.scrollToTime, scrollToTime = _this$props$scrollToT === void 0 ? localizer.startOf(/* @__PURE__ */ new Date(), "day") : _this$props$scrollToT, _this$props$enableAut = _this$props.enableAutoScroll, enableAutoScroll = _this$props$enableAut === void 0 ? true : _this$props$enableAut, props = (0, _objectWithoutProperties2.default)(_this$props, _excluded);
          var range = Week2.range(date2, this.props);
          return _react.default.createElement(_TimeGrid.default, Object.assign({}, props, {
            range,
            eventOffset: 15,
            localizer,
    ...
    Week.title = function(date2, _ref3) {
      ...
      var _Week$range = Week.range(date2, {
        localizer
      }), _Week$range2 = (0, _toArray2.default)(_Week$range), start = _Week$range2[0], rest = _Week$range2.slice(1);
...
var require_WorkWeek = __commonJS({
  "node_modules/react-big-calendar/lib/WorkWeek.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
    ...
    var _inherits2 = _interopRequireDefault(require_inherits());
    var _react = _interopRequireDefault(require_react());
    var _Week = _interopRequireDefault(require_Week());
    var _TimeGrid = _interopRequireDefault(require_TimeGrid());
    var _excluded = ["date", "localizer", "min", "max", "scrollToTime", "enableAutoScroll"];
    function workWeekRange(date2, options) {
      return _Week.default.range(date2, options).filter(function(d) {
        return [6, 0].indexOf(d.getDay()) === -1;
      });
    }
    var WorkWeek = function(_React$Component) {
      function WorkWeek2() {
        (0, _classCallCheck2.default)(this, WorkWeek2);
        return (0, _callSuper2.default)(this, WorkWeek2, arguments);
      }
      (0, _inherits2.default)(WorkWeek2, _React$Component);
      return (0, _createClass2.default)(WorkWeek2, [{
        key: "render",
        value: function render() {
          var _this$props = this.props, date2 = _this$props.date, localizer = _this$props.localizer, _this$props$min = _this$props.min, min2 = _this$props$min === void 0 ? localizer.startOf(/* @__PURE__ */ new Date(), "day") : _this$props$min, _this$props$max = _this$props.max, max2 = _this$props$max === void 0 ? localizer.endOf(/* @__PURE__ */ new Date(), "day") : _this$props$max, _this$props$scrollToT = _this$props.scrollToTime, scrollToTime = _this$props$scrollToT === void 0 ? localizer.startOf(/* @__PURE__ */ new Date(), "day") : _this$props$scrollToT, _this$props$enableAut = _this$props.enableAutoScroll, enableAutoScroll = _this$props$enableAut === void 0 ? true : _this$props$enableAut, props = (0, _objectWithoutProperties2.default)(_this$props, _excluded);
          var range = workWeekRange(date2, this.props);
          return _react.default.createElement(_TimeGrid.default, Object.assign({}, props, {
            range,
            eventOffset: 15,
            localizer,
    ...
    WorkWeek.title = function(date2, _ref) {
      ...
      var _workWeekRange = workWeekRange(date2, {
        localizer
      }), _workWeekRange2 = (0, _toArray2.default)(_workWeekRange), start = _workWeekRange2[0], rest = _workWeekRange2.slice(1);
      return localizer.format({
        start,
        end: rest.pop()
      }, "dayRangeHeaderFormat");
...
var require_Agenda = __commonJS({
  "node_modules/react-big-calendar/lib/Agenda.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    var _interopRequireWildcard = require_interopRequireWildcard().default;
    Object.defineProperty(exports, "__esModule", {
    ...
    exports.default = void 0;
    var _react = _interopRequireWildcard(require_react());
    var _addClass = _interopRequireDefault((init_addClass(), __toCommonJS(addClass_exports)));
    var _removeClass = _interopRequireDefault((init_removeClass(), __toCommonJS(removeClass_exports)));
    var _width = _interopRequireDefault((init_width(), __toCommonJS(width_exports)));
    var _scrollbarSize = _interopRequireDefault((init_scrollbarSize(), __toCommonJS(scrollbarSize_exports)));
    var _constants = require_constants();
    var _eventLevels = require_eventLevels();
    ...
    function Agenda(_ref) {
      ...
      var renderDay = function renderDay2(day2, events2, dayKey) {
        ...
        events2 = events2.filter(function(e) {
          return (0, _eventLevels.inRange)(e, localizer.startOf(day2, "day"), localizer.endOf(day2, "day"), accessors, localizer);
        });
        return events2.map(function(event, idx) {
          var title = accessors.title(event);
          var end2 = accessors.end(event);
          var start = accessors.start(event);
          var userProps = getters.eventProp(event, start, end2, (0, _selection.isSelected)(event, selected));
          ...
          }, timeRangeLabel(day2, event)), _react.default.createElement("td", {
      ...
      var range = localizer.range(date2, end, "day");
      events = events.filter(function(event) {
        return (0, _eventLevels.inRange)(event, localizer.startOf(date2, "day"), localizer.endOf(end, "day"), accessors, localizer);
      });
...
var require_Views = __commonJS({
  "node_modules/react-big-calendar/lib/Views.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
    ...
    var _Week = _interopRequireDefault(require_Week());
    var _WorkWeek = _interopRequireDefault(require_WorkWeek());
    var _Agenda = _interopRequireDefault(require_Agenda());
...
var require_move = __commonJS({
  "node_modules/react-big-calendar/lib/utils/move.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
    ...
    function moveDate(View, _ref) {
      var action = _ref.action, date2 = _ref.date, today = _ref.today, props = (0, _objectWithoutProperties2.default)(_ref, _excluded);
...
var require_Calendar = __commonJS({
  "node_modules/react-big-calendar/lib/Calendar.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
    ...
    var _clsx = _interopRequireDefault((init_clsx_m(), __toCommonJS(clsx_m_exports)));
    var _react = _interopRequireDefault(require_react());
    var _uncontrollable = (init_esm(), __toCommonJS(esm_exports));
    var _propTypes = require_propTypes();
    var _localizer = require_localizer();
    var _NoopWrapper = _interopRequireDefault(require_NoopWrapper());
    ...
    var Calendar = function(_React$Component) {
      function Calendar2() {
        var _this;
        (0, _classCallCheck2.default)(this, Calendar2);
        for (var _len = arguments.length, _args = new Array(_len), _key = 0; _key < _len; _key++) {
          _args[_key] = arguments[_key];
        }
        _this = (0, _callSuper2.default)(this, Calendar2, [].concat(_args));
        ...
        _this.handleNavigate = function(action, newDate) {
          var _this$props3 = _this.props, view = _this$props3.view, date2 = _this$props3.date, getNow = _this$props3.getNow, onNavigate = _this$props3.onNavigate, props = (0, _objectWithoutProperties2.default)(_this$props3, _excluded);
          var ViewComponent = _this.getView();
          var today = getNow();
          date2 = (0, _move.default)(ViewComponent, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, props), {}, {
            action,
        ...
        _this.handleDrillDown = function(date2, view) {
          ...
          _this.handleNavigate(_constants.navigate.DATE, date2);
        };
        _this.state = {
      ...
      return (0, _createClass2.default)(Calendar2, [{
        ...
        value: function render() {
          ...
          return _react.default.createElement("div", Object.assign({}, elementProps, {
            ...
            localizer
          }), _react.default.createElement(View, Object.assign({}, props, {
            events,
            backgroundEvents,
            date: current,
            getNow,
...
var require_moment = __commonJS({
  "node_modules/react-big-calendar/lib/localizers/moment.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
    ...
    var dateRangeFormat = function dateRangeFormat2(_ref2, culture, local) {
    ...
    function _default(moment) {
      ...
      function getTimezoneOffset(date2) {
        return moment(date2).toDate().getTimezoneOffset();
      }
      function getDstOffset(start, end) {
      ...
      function startOf2() {
        ...
        var datePart = fixUnit(unit);
        if (datePart) {
          return moment(date2).startOf(datePart).toDate();
        }
      ...
      function endOf2() {
        ...
        var datePart = fixUnit(unit);
        if (datePart) {
          return moment(date2).endOf(datePart).toDate();
        }
        return moment(date2).toDate();
      }
      function eq2(a, b, unit) {
        var _defineComparators = defineComparators(a, b, unit), _defineComparators2 = (0, _slicedToArray2.default)(_defineComparators, 3), dtA = _defineComparators2[0], dtB = _defineComparators2[1], datePart = _defineComparators2[2];
      ...
      function gt2(a, b, unit) {
        var _defineComparators3 = defineComparators(a, b, unit), _defineComparators4 = (0, _slicedToArray2.default)(_defineComparators3, 3), dtA = _defineComparators4[0], dtB = _defineComparators4[1], datePart = _defineComparators4[2];
        return dtA.isAfter(dtB, datePart);
      }
      function lt2(a, b, unit) {
        var _defineComparators5 = defineComparators(a, b, unit), _defineComparators6 = (0, _slicedToArray2.default)(_defineComparators5, 3), dtA = _defineComparators6[0], dtB = _defineComparators6[1], datePart = _defineComparators6[2];
        return dtA.isBefore(dtB, datePart);
      }
      function gte2(a, b, unit) {
        var _defineComparators7 = defineComparators(a, b, unit), _defineComparators8 = (0, _slicedToArray2.default)(_defineComparators7, 3), dtA = _defineComparators8[0], dtB = _defineComparators8[1], datePart = _defineComparators8[2];
        return dtA.isSameOrBefore(dtB, datePart);
      }
      function lte2(a, b, unit) {
        var _defineComparators9 = defineComparators(a, b, unit), _defineComparators10 = (0, _slicedToArray2.default)(_defineComparators9, 3), dtA = _defineComparators10[0], dtB = _defineComparators10[1], datePart = _defineComparators10[2];
        return dtA.isSameOrBefore(dtB, datePart);
      }
      function inRange2(day2, min3, max3) {
        var unit = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : "day";
        var datePart = fixUnit(unit);
        var mDay = moment(day2);
        var mMin = moment(min3);
        var mMax = moment(max3);
      ...
      function merge(date2, time) {
        ...
        var dt = moment(date2).startOf("day").format("MM/DD/YYYY");
        return moment("".concat(dt, " ").concat(tm), "MM/DD/YYYY HH:mm:ss").toDate();
      }
      function add2(date2, adder, unit) {
        var datePart = fixUnit(unit);
        return moment(date2).add(adder, datePart).toDate();
      }
      function range(start, end) {
        var unit = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "day";
        var datePart = fixUnit(unit);
      ...
      function firstVisibleDay(date2) {
        return moment(date2).startOf("month").startOf("week").toDate();
      }
      function lastVisibleDay(date2) {
        return moment(date2).endOf("month").endOf("week").toDate();
      }
      function visibleDays(date2) {
        var current = firstVisibleDay(date2);
        var last = lastVisibleDay(date2);
        var days = [];
      ...
      function getSlotDate(dt, minutesFromMidnight, offset2) {
        return moment(dt).startOf("day").minute(minutesFromMidnight + offset2).toDate();
      }
      function getTotalMin(start, end) {
...
// node_modules/react-big-calendar/lib/localizers/luxon.js
var require_luxon = __commonJS({
  "node_modules/react-big-calendar/lib/localizers/luxon.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
    ...
    function _default(DateTime) {
      ...
      function eq2(a, b, unit) {
        var _defineComparators = defineComparators(a, b, unit), _defineComparators2 = (0, _slicedToArray2.default)(_defineComparators, 2), dtA = _defineComparators2[0], dtB = _defineComparators2[1];
        return +dtA == +dtB;
      }
      function neq2(a, b, unit) {
        return !eq2(a, b, unit);
      ...
      function gt2(a, b, unit) {
        var _defineComparators3 = defineComparators(a, b, unit), _defineComparators4 = (0, _slicedToArray2.default)(_defineComparators3, 2), dtA = _defineComparators4[0], dtB = _defineComparators4[1];
        return +dtA > +dtB;
      }
      function lt2(a, b, unit) {
        var _defineComparators5 = defineComparators(a, b, unit), _defineComparators6 = (0, _slicedToArray2.default)(_defineComparators5, 2), dtA = _defineComparators6[0], dtB = _defineComparators6[1];
        return +dtA < +dtB;
      }
      function gte2(a, b, unit) {
        var _defineComparators7 = defineComparators(a, b, unit), _defineComparators8 = (0, _slicedToArray2.default)(_defineComparators7, 2), dtA = _defineComparators8[0], dtB = _defineComparators8[1];
        return +dtA >= +dtB;
      }
      function lte2(a, b, unit) {
        var _defineComparators9 = defineComparators(a, b, unit), _defineComparators10 = (0, _slicedToArray2.default)(_defineComparators9, 2), dtA = _defineComparators10[0], dtB = _defineComparators10[1];
        return +dtA <= +dtB;
      }
      function inRange2(day2, min3, max3) {
        var unit = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : "day";
      ...
      function add2(date2, adder, unit) {
        var datePart = fixUnit(unit);
        return DateTime.fromJSDate(date2).plus((0, _defineProperty2.default)({}, datePart, adder)).toJSDate();
      }
      function range(start, end) {
        var unit = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "day";
        var datePart = fixUnit(unit);
...
var require_oldGlobalize = __commonJS({
  "node_modules/react-big-calendar/lib/localizers/oldGlobalize.js"(exports) {
    "use strict";
    var _interopRequireWildcard = require_interopRequireWildcard().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
    ...
    exports.default = _default;
    exports.formats = void 0;
    var dates = _interopRequireWildcard(require_dates());
    var _localizer = require_localizer();
...
var require_globalize = __commonJS({
  "node_modules/react-big-calendar/lib/localizers/globalize.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    var _interopRequireWildcard = require_interopRequireWildcard().default;
    Object.defineProperty(exports, "__esModule", {
    ...
    exports.formats = void 0;
    var dates = _interopRequireWildcard(require_dates());
    var _oldGlobalize = _interopRequireDefault(require_oldGlobalize());
    var _localizer = require_localizer();
    var dateRangeFormat = function dateRangeFormat2(_ref, culture, local) {
      var start = _ref.start, end = _ref.end;
...
// node_modules/react-big-calendar/lib/localizers/date-fns.js
var require_date_fns = __commonJS({
  "node_modules/react-big-calendar/lib/localizers/date-fns.js"(exports) {
    "use strict";
    var _interopRequireWildcard = require_interopRequireWildcard().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
...
// node_modules/react-big-calendar/lib/localizers/dayjs.js
var require_dayjs = __commonJS({
  "node_modules/react-big-calendar/lib/localizers/dayjs.js"(exports) {
    "use strict";
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
    ...
    var _slicedToArray2 = _interopRequireDefault(require_slicedToArray());
    var _localizer = require_localizer();
    var _isBetween = _interopRequireDefault(require_isBetween());
    var _isSameOrAfter = _interopRequireDefault(require_isSameOrAfter());
    var _isSameOrBefore = _interopRequireDefault(require_isSameOrBefore());
    var _localeData = _interopRequireDefault(require_localeData());
    var _localizedFormat = _interopRequireDefault(require_localizedFormat());
    var _minMax = _interopRequireDefault(require_minMax());
    ...
    function _default(dayjsLib) {
      ...
      function getTimezoneOffset(date2) {
        return dayjs(date2).toDate().getTimezoneOffset();
      }
      function getDstOffset(start, end) {
      ...
      function startOf2() {
        ...
        var datePart = fixUnit(unit);
        if (datePart) {
          return dayjs(date2).startOf(datePart).toDate();
        }
        return dayjs(date2).toDate();
      }
      function endOf2() {
        var date2 = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : null;
        var unit = arguments.length > 1 ? arguments[1] : void 0;
        var datePart = fixUnit(unit);
        if (datePart) {
          return dayjs(date2).endOf(datePart).toDate();
        }
        return dayjs(date2).toDate();
      }
      function eq2(a, b, unit) {
      ...
      function inRange2(day2, min3, max3) {
        var unit = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : "day";
        var datePart = fixUnit(unit);
        var djDay = dayjs(day2);
        var djMin = dayjs(min3);
        var djMax = dayjs(max3);
      ...
      function merge(date2, time) {
        ...
        var dt = dayjs(date2).startOf("day").format("MM/DD/YYYY");
        return dayjsLib("".concat(dt, " ").concat(tm), "MM/DD/YYYY HH:mm:ss").toDate();
      }
      function add2(date2, adder, unit) {
        var datePart = fixUnit(unit);
        return dayjs(date2).add(adder, datePart).toDate();
      }
      function range(start, end) {
        var unit = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : "day";
        var datePart = fixUnit(unit);
      ...
      function firstVisibleDay(date2) {
        return dayjs(date2).startOf("month").startOf("week").toDate();
      }
      function lastVisibleDay(date2) {
        return dayjs(date2).endOf("month").endOf("week").toDate();
      }
      function visibleDays(date2) {
        var current = firstVisibleDay(date2);
        var last = lastVisibleDay(date2);
      ...
      function getSlotDate(dt, minutesFromMidnight, offset2) {
        return dayjs(dt).startOf("day").minute(minutesFromMidnight + offset2).toDate();
      }
      function getTotalMin(start, end) {
        return diff2(start, end, "minutes");
      }
...
var require_lib = __commonJS({
  "node_modules/react-big-calendar/lib/index.js"(exports) {
    var _interopRequireDefault = require_interopRequireDefault().default;
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    ...
    var _luxon = _interopRequireDefault(require_luxon());
    var _globalize = _interopRequireDefault(require_globalize());
    var _dateFns = _interopRequireDefault(require_date_fns());
